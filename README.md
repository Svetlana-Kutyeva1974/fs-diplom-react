...
Если в зале существуют сеансы, то вкладка с информацией о зале недоступна(запрет на редактирование конфигурации,
...
Удаление фильма возможно, если он снят со всех сеансов.
Удаление зала возможно, если в нем нет сеансов.
### ------------------
